...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ContributionFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/MemberFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ProjectFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/TechnologyFixtures.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\ContributionFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\MemberFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\ProjectFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\TechnologyFixtures(), 'groups' => []]]);
